...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Calculate, track, and reduce your carbon footprint with personalized recommendations, eco challenges, and a supportive community." },
      { name: "author", content: "EcoTrack" },
      { property: "og:title", content: "EcoTrack — Track Your Carbon Footprint" },
      { property: "og:description", content: "Build a greener future with daily footprint tracking, challenges, and tips." },
